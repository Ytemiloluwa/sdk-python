...
check_feature_support_compatibility: AsyncMock = AsyncMock(
    spec=ISDK.check_feature_support_compatibility
)

wait_for_result: AsyncMock = AsyncMock(spec=ISDK.wait_for_result)
get_sequence_number_mock: AsyncMock = AsyncMock(
    spec=ISDK.get_sequence_number, side_effect=get_sequence_number
)
get_new_sequence_number_mock: AsyncMock = AsyncMock(
    spec=ISDK.get_new_sequence_number, side_effect=get_new_sequence_number
)
...
run_operation: AsyncMock = AsyncMock(
    spec=ISDK.run_operation, side_effect=run_operation_impl
)

destroy: AsyncMock = AsyncMock(spec=ISDK.destroy)
get_device_state: AsyncMock = AsyncMock(
    spec=ISDK.get_device_state, return_value=DeviceState.MAIN
)
