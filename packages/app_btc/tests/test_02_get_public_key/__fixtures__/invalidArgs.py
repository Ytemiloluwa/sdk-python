...
common_params = {
    ...
    "error_message": re.compile(
        r"AssertionError|Params should be defined|missing.*required.*argument|DerivationPath should be of depth"
    ),  # Match various error messages
}

invalid_args_fixtures = [
    GetPublicKeyTestCase(name="Null", params=None, **common_params),
    GetPublicKeyTestCase(name="Undefined", params=None, **common_params),
    GetPublicKeyTestCase(name="Empty Object", params={}, **common_params),
    GetPublicKeyTestCase(
        name="No derivation path", params={"wallet_id": bytes([])}, **common_params
    ),
    GetPublicKeyTestCase(
        name="No wallet id",
        params={
