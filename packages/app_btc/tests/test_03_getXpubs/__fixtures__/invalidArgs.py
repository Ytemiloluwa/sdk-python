...
invalid_args_fixtures = [
    GetXpubsTestCase(name="Null", params=None, **common_params),
    GetXpubsTestCase(name="Undefined", params=None, **common_params),
    GetXpubsTestCase(name="Empty Object", params={}, **common_params),
    GetXpubsTestCase(
        name="No derivation paths", params={"wallet_id": bytes([])}, **common_params
    ),
    GetXpubsTestCase(
        name="No wallet id",
        params={
